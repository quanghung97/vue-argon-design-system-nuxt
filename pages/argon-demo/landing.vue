              ...
              <div class="col-lg-4">
                <card class="border-0"
                  ...
                  <base-button tag="a"
                               href="#"
                               type="primary"
                               class="mt-4">Learn more</base-button>
                </card>
              </div>
              <div class="col-lg-4">
                <card class="border-0"
          ...
          <div class="col-lg-8">
            <card gradient="secondary" shadow body-classes="p-lg-5">
              ...
              <base-button type="default"
                           round
                           block
                           size="lg">Send Message</base-button>
            </card>
          </div>
        </div>
      </div>
