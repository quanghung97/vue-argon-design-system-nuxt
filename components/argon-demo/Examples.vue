      ...
      <div class="row row-grid justify-content-between align-items-center">
        <div class="col-lg-6">
          ...
          <div class="btn-wrapper">
            <nuxt-link :to="{name: 'argon-demo-login'}" class="btn btn-success">Login Page</nuxt-link>
            <nuxt-link :to="{name: 'argon-demo-register'}" class="btn btn-success">Register Page</nuxt-link>
          </div>
        </div>
